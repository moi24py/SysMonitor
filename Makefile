all: build/cpu.o build/mem.o build/disk.o
	gcc -std=c99 -Wall -Wextra -pedantic -O2 -g -I include build/cpu.o build/mem.o build/disk.o tools/main.c -o build/main
